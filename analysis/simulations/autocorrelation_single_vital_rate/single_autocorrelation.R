...
if(foption == "HEQU") {
  source("/home/evers/lagged_buffering/analysis/simulations/autocorrelation_single_vital_rate/ipmr_functions_HEQU.R")
}
if(foption == "OPIM") {
  source("/home/evers/lagged_buffering/analysis/simulations/autocorrelation_single_vital_rate/ipmr_functions_OPIM.R")
}
